...
#   MODEL EVALUATION (MLE_SIM_ACC_M100_SEL1)
...
sim <- "MLE_SIM_ACC_M100_SEL1"            # simulation name
...
prob[["study_accuracy"]] <- 
  CJ(load.folder = load.dir,
     load.base = "job",
     load.id = ids,
     methods = c("glmnet|xgbTree", "glmnet|rpartCost", "glmnet|svmLinearWeights2"),
                 #"xgbTree|rpartCost", "xgbTree|svmLinearWeights2", "rpartCost|svmLinearWeights2"),
     M = 100,
     M.start = 1, 
     M.probs = "uniform",
     M.seed = 1337,
