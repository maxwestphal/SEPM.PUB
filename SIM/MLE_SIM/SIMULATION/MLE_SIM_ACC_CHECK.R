...
#   MODEL EVALUATION (MLE_SIM_ACC_CHECK)
...
load.dir <- "D:/SIM/MLE_SIM/DATA/DATA" 

JP.data <- readr::read_csv("D:/SIM/MLE_SIM/RESULTS/MLE_SIM_DATA_CHECK_JP.csv")
ids <- JP.data$job.id
