...
DATA <- readRDS("RWD/CTG2/DATA.rds")
R <- readRDS("RWD/CTG2/RESULTS.rds")

source("RWD/CTG2/MLE_RWD_CPE_functions.R")
...
comp_val <- SEPM::define_target("sensspec") %>% 
  SEPM::define_hypothesis(threshold=threshold) %>% 
