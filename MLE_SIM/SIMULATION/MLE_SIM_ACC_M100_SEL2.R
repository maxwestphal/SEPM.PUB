...
#   MODEL EVALUATION (MLE_SIM_ACC_M100_SEL2)
...
sim <- "MLE_SIM_ACC_M100_SEL2"             # simulation name
...
prob[["study_accuracy"]] <- 
  CJ(load.folder = load.dir,
     load.base = "job",
     load.id = ids,
     methods = c("xgbTree|rpartCost", "xgbTree|svmLinearWeights2", "rpartCost|svmLinearWeights2"),
     M = 100,
     M.start = 1, 
     M.probs = "uniform",
     M.seed = 1337,
