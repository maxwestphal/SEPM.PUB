...
So far, two real data examples are available, both described by **Westphal & Brannath (2019, SMMR)**. They are currently only available as part of the older [**EOMPM**](https://github.com/maxwestphal/EOMPM) project. At some point these will be recompiled for easier access... 
